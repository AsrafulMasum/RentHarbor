  ...
  return (
    <div className="max-w-screen-xl mx-4 lg:mx-auto my-16">
      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center items-center gap-10 mt-16">
        <div className="p-10 border text-center flex flex-col justify-center items-center gap-4 shadow-md hover:shadow-xl duration-700 group lg:w-1/4 h-96 hover:rounded-bl-[100px] hover:rounded-tr-[100px]">
